...
for FAMILY in $(awk 'BEGIN {FS="\t"} {print $19}' ~/CGC_PIPELINE_TEMP/$MANIFEST_PREFIX.$PED_PREFIX.join.txt | sort | uniq);
	do
		HOLD_ID_PATH=$HOLD_ID_PATH"L.01_APPLY_RECALIBRATION_INDEL_"$FAMILY"_"$PROJECT","
	done
done
}
...
echo \
qsub \
-N P.01_VARIANT_ANNOTATOR_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_chr$CHROM \
$HOLD_ID_PATH \
-o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/LOGS/${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.ADD_MORE_ANNOTATION_chr$CHROM.log \
$SCRIPT_DIR/P.01_VARIANT_ANNOTATOR_SCATTER.sh \
$JAVA_1_7 $GATK_DIR $CORE_PATH $PED_FILE \
${FAMILY_INFO_ARRAY[0]} ${FAMILY_INFO_ARRAY[2]} ${FAMILY_INFO_ARRAY[3]} $CHROM
echo sleep 1s
done
}
...
BUILD_HOLD_ID_PATH_ADD_MORE_ANNOTATION ()
{
	...
	for CHR in {{1..22},{X,Y}};
 	do
 		HOLD_ID_PATH=$HOLD_ID_PATH"P.01_VARIANT_ANNOTATOR_"$FAMILY"_"$PROJECT"_chr"$CHR","
 	done
 done
}
...
echo \
qsub \
-N P.01-A.03_FILTER_TO_FAMILY_ALL_SITES_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-hold_jid P.01_VARIANT_ANNOTATOR_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_chr$CHROMOSOME \
-o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/LOGS/${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.FILTER_TO_FAMILY_ALL_SITES_$CHROMOSOME.log \
...
echo \
qsub \
-N T.03-2_VARIANT_TO_TABLE_FAMILY_ALL_SITES_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-hold_jid P.01-A.03_VARIANT_ANNOTATOR_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/LOGS/${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.VARIANT_TO_TABLE_FAMILY_ALL_SITES_$CHROMOSOME.log \
...
echo \
qsub \
-N P.01-A.04_FILTER_TO_SAMPLE_ALL_SITES_${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-hold_jid P.01_VARIANT_ANNOTATOR_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_chr$CHROMOSOME \
-o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/${FAMILY_INFO_ARRAY[1]}/LOGS/${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.FILTER_TO_SAMPLE_ALL_SITES_$CHROMOSOME.log \
$SCRIPT_DIR/P.01-A.04_FILTER_TO_SAMPLE_ALL_SITES_CHR.sh \
$JAVA_1_7 $GATK_DIR $CORE_PATH \
${FAMILY_INFO_ARRAY[0]} ${FAMILY_INFO_ARRAY[2]} ${FAMILY_INFO_ARRAY[1]} ${FAMILY_INFO_ARRAY[3]} $CHROMOSOME
}
...
BUILD_HOLD_ID_PATH_FILTER_TO_SAMPLE_VCF ()
{
	...
	for CHROMOSOME in {{1..22},{X,Y}};
 	do
 		HOLD_ID_PATH=$HOLD_ID_PATH"P.01-A.04_FILTER_TO_SAMPLE_ALL_SITES_"$SAMPLE"_"$FAMILY"_"$PROJECT"_"$CHROMOSOME","
 	done
 done
}
...
echo \
qsub \
-N T.06-1_FILTER_TO_SAMPLE_ALL_SITES_GATHER_${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]} \
 ${HOLD_ID_PATH} \
 -o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/${FAMILY_INFO_ARRAY[1]}/LOGS/${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.FILTER_TO_SAMPLE_ALL_SITES_GATHER.log \
 $SCRIPT_DIR/T.06-1_FILTER_TO_SAMPLE_ALL_SITES_GATHER.sh \
 $JAVA_1_7 $GATK_DIR $CORE_PATH \
 ${FAMILY_INFO_ARRAY[0]} ${FAMILY_INFO_ARRAY[2]} ${FAMILY_INFO_ARRAY[1]} ${FAMILY_INFO_ARRAY[3]}
}
...
echo \
qsub \
-N T.06-2_VARIANT_TO_TABLE_SAMPLE_ALL_SITES_${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-hold_jid P.01-A.04_FILTER_TO_SAMPLE_ALL_SITES_${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/${FAMILY_INFO_ARRAY[1]}/LOGS/${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.VARIANT_TO_TABLE_SAMPLE_ALL_SITES_$CHROMOSOME.log \
...
BUILD_HOLD_ID_PATH_VARIANT_TO_TABLE_SAMPLE_GATHER ()
{
	...
	for CHROMOSOME in {{1..22},{X,Y}};
 	do
 		HOLD_ID_PATH=$HOLD_ID_PATH"T.06-2_VARIANT_TO_TABLE_SAMPLE_ALL_SITES_"$SAMPLE"_"$FAMILY"_"$PROJECT"_"$CHROMOSOME","
 	done
 done
}
...
echo \
qsub \
-N T.06-2-A.01_VARIANT_TO_TABLE_SAMPLE_ALL_SITES_GATHER_${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]} \
 ${HOLD_ID_PATH} \
 -o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/${FAMILY_INFO_ARRAY[1]}/LOGS/${FAMILY_INFO_ARRAY[1]}_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.FILTER_TO_SAMPLE_ALL_SITES_GATHER.log \
...
echo \
qsub \
-N P.01-A.02_VARIANT_TO_TABLE_COHORT_ALL_SITES_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-hold_jid P.01_VARIANT_ANNOTATOR_${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}_$CHROMOSOME \
-o $CORE_PATH/${FAMILY_INFO_ARRAY[0]}/${FAMILY_INFO_ARRAY[2]}/LOGS/${FAMILY_INFO_ARRAY[2]}_${FAMILY_INFO_ARRAY[0]}.VARIANT_TO_TABLE_COHORT_ALL_SITES_$CHROMOSOME.log \
