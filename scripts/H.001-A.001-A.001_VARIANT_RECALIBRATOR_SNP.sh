...
-R $REF_GENOME \
--input:VCF $CORE_PATH/$PROJECT/$FAMILY/VCF/RAW/$FAMILY".RAW.vcf" \
...
-tranche 95.0 \
-tranche 90.0 \
-recalFile $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.recal" \
-tranchesFile $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.tranches" \
-rscriptFile $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.R"

END_VARIANT_RECALIBRATOR_SNP=`date '+%s'`

HOSTNAME=`hostname`

echo $FAMILY"_"$PROJECT",J.001,VARIANT_RECALIBRATOR_SNP,"$HOSTNAME","$START_VARIANT_RECALIBRATOR_SNP","$END_VARIANT_RECALIBRATOR_SNP \
...
md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.recal" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.recal.idx" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.tranches" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.tranches.pdf" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.R" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.SNV.R.pdf" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"
