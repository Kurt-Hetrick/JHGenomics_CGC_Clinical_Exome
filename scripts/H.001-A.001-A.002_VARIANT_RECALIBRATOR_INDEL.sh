...
-rscriptFile $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.INDEL.R"

END_VARIANT_RECALIBRATOR_INDEL=`date '+%s'`

HOSTNAME=`hostname`

echo $FAMILY"_"$PROJECT",J.001,VARIANT_RECALIBRATOR_INDEL,"$HOSTNAME","$START_VARIANT_RECALIBRATOR_INDEL","$END_VARIANT_RECALIBRATOR_INDEL \
...
md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.INDEL.recal" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.INDEL.recal.idx" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.INDEL.tranches" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.INDEL.R" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".HC.INDEL.R.pdf" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"
