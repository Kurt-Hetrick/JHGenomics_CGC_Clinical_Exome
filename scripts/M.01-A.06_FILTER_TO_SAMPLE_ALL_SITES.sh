...
-o $CORE_PATH/$PROJECT/$FAMILY/$SM_TAG/VCF/FILTERED_ON_BAIT/$SM_TAG".ALL_SITES.vcf"

END_FILTER_TO_SAMPLE_ALL_SITES=`date '+%s'`

HOSTNAME=`hostname`

echo $FAMILY"_"$PROJECT",N.001,FILTER_TO_SAMPLE_ALL_SITES,"$HOSTNAME","$START_FILTER_TO_SAMPLE_ALL_SITES","$END_FILTER_TO_SAMPLE_ALL_SITES \
