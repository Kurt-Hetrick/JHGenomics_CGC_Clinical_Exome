...
sort -k 2 $CORE_PATH/$PROJECT/TEMP/SAMPLE_META.txt \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/TARGET_SNV_METRICS.TXT \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/TITV_ALL.TXT \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/TITV_KNOWN.TXT \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/TITV_NOVEL.TXT \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/BAIT_INDEL_METRICS.TXT \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/TARGET_INDEL_METRICS.TXT \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/BAIT_MIXED_METRICS.TXT \
| uniq \
...
sort -k 1 $CORE_PATH/$PROJECT/TEMP/TARGET_MIXED_METRICS.TXT \
| uniq \
...
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/VERFIY_BAM_ID_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/INSERT_SIZE_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/ALIGNMENT_SUMMARY_READ_1_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/ALIGNMENT_SUMMARY_READ_2_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/ALIGNMENT_SUMMARY_READ_PAIR_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/MARK_DUPLICATES_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/HYB_SELECTION_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/BAIT_BIAS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/PRE_ADAPTER_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/BAIT_SNV_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/TARGET_SNV_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/TITV_ALL_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/TITV_KNOWN_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/TITV_NOVEL_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/BAIT_INDEL_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/TARGET_INDEL_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/BAIT_MIXED_METRICS_HEADER.TXT \
| join -i -1 2 -2 1 /dev/stdin $CORE_PATH/$PROJECT/TEMP/TARGET_MIXED_METRICS_HEADER.TXT \
| sed 's/ /,/g' \
