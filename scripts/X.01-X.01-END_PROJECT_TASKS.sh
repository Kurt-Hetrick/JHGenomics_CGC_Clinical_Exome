...
| uniq \
| awk 'BEGIN {print "SM_TAG","TOTAL_READS","RAW_GIGS","PF_NOISE_READS_PAIR","PF_READS_ALIGNED_PAIR","PCT_PF_READS_ALIGNED_PAIR",\
...
| uniq \
| awk 'BEGIN {print "SM_TAG","COUNT_ALL_INDEL_BAIT","ALL_INDEL_BAIT_PCT_SNP138","COUNT_BIALLELIC_INDEL_BAIT","BIALLELIC_INDEL_BAIT_PCT_SNP138",\
...
"I_D_RATIO_BAIT","I_D_RATIO_GT15_BAIT","I_D_RATIO_LT15_BAIT","I_1AND2_VS_3_BAIT","D_1AND2_VS_3_BAIT","BIGGEST_INSERTION_BAIT","BIGGEST_DELETION_BAIT"} {print $0}' \
| sed 's/ /\t/g' \
...
| uniq \
| awk 'BEGIN {print "SM_TAG","COUNT_ALL_INDEL_TARGET","ALL_INDEL_TARGET_PCT_SNP138","COUNT_BIALLELIC_INDEL_TARGET","BIALLELIC_INDEL_TARGET_PCT_SNP138",\
...
"I_D_RATIO_TARGET","I_D_RATIO_GT15_TARGET","I_D_RATIO_LT15_TARGET","I_1AND2_VS_3_TARGET","D_1AND2_VS_3_TARGET","BIGGEST_INSERTION_TARGET","BIGGEST_DELETION_TARGET"} {print $0}' \
| sed 's/ /\t/g' \
