...
-R $REF_GENOME \
--variant $CORE_PATH/$PROJECT/$FAMILY/$SM_TAG/VCF/FILTERED_ON_BAIT/$SM_TAG".ALL_SITES.vcf.gz" \
--fields CHROM \
--fields POS \
--fields ID \
--fields REF \
...
echo $FAMILY"_"$PROJECT",T.01,VARIANT_TO_TABLE_"$SM_TAG"_ALL_SITES,"$HOSTNAME","$START_VARIANT_TO_TABLE_SAMPLE","$END_VARIANT_TO_TABLE_SAMPLE \
