...
echo $FAMILY"_"$PROJECT",N.001,FILTER_TO_SAMPLE_TARGET_INDEL_PASS,"$HOSTNAME","$START_FILTER_TO_SAMPLE_TARGET_INDEL_PASS","$END_FILTER_TO_SAMPLE_TARGET_INDEL_PASS \
