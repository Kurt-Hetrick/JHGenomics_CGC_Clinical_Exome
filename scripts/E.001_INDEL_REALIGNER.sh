...
-known $KNOWN_INDEL_1 \
-known $KNOWN_INDEL_2 \
-targetIntervals $CORE_PATH/$PROJECT/$FAMILY/$REPORTS/$SM_TAG/REPORTS/LOCAL_REALIGNMENT_INTERVALS/$SM_TAG"_LOCAL_REALIGNMENT_INTERVALS.intervals" \
-dt NONE \
...
echo $SM_TAG"_"$PROJECT",INDEL_REALIGNER,"$HOSTNAME","$START_INDEL_REALIGNER","$END_INDEL_REALIGNER \
