...
--outputFile $CORE_PATH/$PROJECT/$FAMILY/$SM_TAG/VCF/$SM_TAG".ALL_SITES.vcf.gz"
...
md5sum $CORE_PATH/$PROJECT/$FAMILY/$SM_TAG/VCF/$SM_TAG".ALL_SITES.vcf.gz" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/$SM_TAG/VCF/$SM_TAG".ALL_SITES.vcf.gz.tbi" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"
