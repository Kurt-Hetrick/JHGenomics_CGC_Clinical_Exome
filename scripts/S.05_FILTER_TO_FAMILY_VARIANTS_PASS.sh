...
echo $FAMILY"_"$PROJECT",S.01,FILTER_TO_FAMILY_VARIANTS_PASS,"$HOSTNAME","$START_FILTER_TO_FAMILY_VARIANTS_PASS","$END_FILTER_TO_FAMILY_VARIANTS_PASS \
...
md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/$FAMILY".VQSR.ANNOTATED.JUST_FAMILY.VARIANT_ONLY.PASS.vcf" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/$FAMILY".VQSR.ANNOTATED.JUST_FAMILY.VARIANT_ONLY.PASS.vcf.idx" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"
