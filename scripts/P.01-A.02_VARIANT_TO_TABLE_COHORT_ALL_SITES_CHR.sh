...
# Convert the controls plus family samples all sites vcf into a tab-delimited specifically for fields that Molly might find useful for sorting/filtering
