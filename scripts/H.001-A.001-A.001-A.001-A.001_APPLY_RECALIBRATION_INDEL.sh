...
echo $FAMILY"_"$PROJECT",L.001,APPLY_RECALIBRATION_INDEL,"$HOSTNAME","$START_APPLY_RECALIBRATION_INDEL","$END_APPLY_RECALIBRATION_INDEL \
...
md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".VQSR.vcf" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"

md5sum $CORE_PATH/$PROJECT/$FAMILY/VCF/VQSR/$FAMILY".VQSR.vcf.idx" \
>> $CORE_PATH/$PROJECT/REPORTS/$PROJECT".CIDR.Analysis.MD5.txt"
