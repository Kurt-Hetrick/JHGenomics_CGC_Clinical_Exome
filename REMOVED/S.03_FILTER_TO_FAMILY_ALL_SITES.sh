...
-o $CORE_PATH/$PROJECT/$FAMILY/VCF/$FAMILY".VQSR.ANNOTATED.JUST_FAMILY.vcf.gz"

END_FILTER_TO_FAMILY_ALL_SITES=`date '+%s'`

HOSTNAME=`hostname`

echo $FAMILY"_"$PROJECT",S.01,FILTER_TO_FAMILY_ALL_SITES,"$HOSTNAME","$START_FILTER_TO_FAMILY_ALL_SITES","$END_FILTER_TO_FAMILY_ALL_SITES \
